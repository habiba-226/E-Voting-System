...
title_label = tk.Label(root, text="Admin Control Panel", font=("Arial", 18, "bold"), bg="#ecf0f1", fg="#2c3e50")
...
delete_label = tk.Label(control_frame, text="Delete Candidate", font=("Arial", 12), bg="#ecf0f1", fg="#374375")
...
add_label = tk.Label(control_frame, text="Add Candidate", font=("Arial", 12), bg="#ecf0f1", fg="#374375")
...
start_button = tk.Button(root, text="Start Server", command=lambda: threading.Thread(target=start_server).start(), font=("Arial", 12, "bold"), bg="#27ae60", fg="white", width=20, relief="raised", bd=2)
start_button.pack(pady=10)

end_button = tk.Button(root, text="End Server", command=lambda: threading.Thread(target=shutdown_server).start(), font=("Arial", 12, "bold"), bg="#c0392b", fg="white", width=20, relief="raised", bd=2)
end_button.pack(pady=10)

# Vote Count Section
vote_count_frame = tk.Frame(root, bg="#ecf0f1")
vote_count_frame.pack(pady=10)

vote_count_label = tk.Label(vote_count_frame, text="Vote Count", font=("Arial", 12), bg="#ecf0f1", fg="#374375")
...
refresh_button = tk.Button(vote_count_frame, text="Refresh", command=lambda: update_vote_count(vote_count_text), font=("Arial", 12, "bold"), bg="#3498db", fg="white", width=20, relief="raised", bd=2)
